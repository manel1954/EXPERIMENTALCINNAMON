...
def cerrar_qt():
    try:
        subprocess.run(['killall', 'qt_menu_inferior'], check=True)
    except Exception as e:
        print(f"Error al cerrar qt_menu_inferior: {e}")

def iniciar_qt():
    try:
        subprocess.Popen(['/home/pi/A108/qt/./qt_menu_inferior'])
    except Exception as e:
        print(f"Error al iniciar qt_menu_inferior: {e}")
...
root.geometry("20x20+1247+661")  # Fijar ventana en esquina superior izquierda
